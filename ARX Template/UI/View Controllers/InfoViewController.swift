...
//        }
    ...
    func description() -> String {
        ...
        case .more:
            return "This breathing program is taught by Denny Prokopos, 10th Planet jiujitsu black belt and multiple time world champion.\n\nHave feedback, comments, suggestions, or complaints? Please let us know!"
        }
    }
}
